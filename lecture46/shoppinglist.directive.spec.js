describe('shoppingList directive', function() {
  ...
  it('Replaces the element with the appropriate content', function() {
    ...
    // Take the html and pass into the compile function which is going to produce a function that expect another argument that is a scope that I could bind things from. The html is able to look for certain things like the 'list' property in this example. This scope in the argument now acts like a data holder for whateer this directive needs.
